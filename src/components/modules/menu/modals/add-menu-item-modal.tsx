...
export function AddMenuItemModal({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const groupId =
      typeof category.group === "string" ? category.group : category.group?._id;
      ...
      <DialogContent className="sm:max-w-[600px] max-h-[80vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            updateVariety(index, "options", e.target.value)
                          }
          ...
          {varieties.length === 0 && (
            <div className="space-y-4">
              ...
              <p className="text-sm text-gray-500">
                No varieties added. Add varieties if this item has different
                sizes, options, or prices.
              </p>
            </div>
          )}
          ...
          <Button
            type="submit"
            disabled={
              createMenuItemMutation.isPending || uploadImageMutation.isPending
            }
            className={
              createMenuItemMutation.isPending || uploadImageMutation.isPending
