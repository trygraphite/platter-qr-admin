...
const ManageStaff = () => {
  ...
  const handleEditStaff = (staff: Staff) => {
    ...
    toast.info(
      `Edit functionality coming soon for staff: ${staff.firstName} ${staff.lastName}`
    );
  };
  ...
  const handleDeleteStaff = (staff: Staff) => {
    ...
    toast.info(
      `Delete functionality coming soon for staff: ${staff.firstName} ${staff.lastName}`
    );
  };
