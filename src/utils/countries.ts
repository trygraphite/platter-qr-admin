...
export const countries: CountryType[] = [
  ...
  { name: 'Antarctica', code: 'AQ', currency: 'N/A' },
  ...
  { name: 'Congo, The Democratic Republic of the', code: 'CD', currency: 'CDF' },
  ...
  { name: 'Venezuela, Bolivarian Republic of', code: 'VE', currency: 'VES' },
